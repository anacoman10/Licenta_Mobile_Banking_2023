...
public class Web3JActivity extends AppCompatActivity{
    Web3j web3;
    File file;
    String Walletname;
...
//enter your own infura api key below
        web3 = Web3j.build(new HttpService("https://mainnet.infura.io/v3/49823f8fa0024d519fa1df8ec2c68421"));
    ...
    public void connectToEthNetwork(View v) {
        ...
        toastAsync(" Now Connecting to Ethereum network");
        try {
    ...
    public void createWallet(View v)  {
        ...
        try {
            ...
            toastAsync("Wallet generated wallet name is ");
    ...
    public void retrieveBalance (View v)  {
        ...
        try {
            EthGetBalance balanceWei = web3.ethGetBalance("0x2a21e3d18120f221efbc7e155458b5e8af2fba85", DefaultBlockParameterName.LATEST).sendAsync()
                    .get();
